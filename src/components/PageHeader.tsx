                ...
                <div className="mt-1 border-t border-slate-100 px-2 pt-2">
                  ...
                  <div className="flex flex-col">
                    <button
                      ...
                      className="flex w-full items-center gap-2 px-2 py-2 text-left text-sm text-slate-700 hover:bg-slate-50"
                    >
                      <Lightbulb
                        className={`h-4 w-4 ${tipsEnabled ? "" : "opacity-50"}`}
                      />
                      <span>
                        {tipsEnabled
                          ? labels.header.tipsOn
                          : labels.header.tipsOff}
                      </span>
                    </button>
                    ...
                    >
                      <Landmark
                        className={`h-4 w-4 ${showGeneralContributions ? "" : "opacity-50"}`}
                      />
                      <span>
                        {showGeneralContributions
                          ? "General Contributions on"
                          : "General Contributions off"}
                      </span>
                    </button>
