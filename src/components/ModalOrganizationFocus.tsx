        ...
        {investmentTypeCounts.map(({ type, count }) => {
          ...
          const button = (
            <button
              ...
              className="inline-flex w-full cursor-pointer items-center justify-between gap-1.5 rounded-md px-3 py-1.5 text-sm font-semibold transition-opacity hover:opacity-80"
              style={{
